...
f32 
SimplexNoise::F2 = 0.5*(sqrt(3.0)-1.0);

f32
SimplexNoise::G2 = (3.0 - sqrt(3.0))/6.0;
...
f32
SimplexNoise::F4 = (sqrt(5.0) - 1.0)/4.0;

f32
SimplexNoise::G4 = (5.0 - sqrt(5.0))/20.0;
...
// 3D simplex noise
f32 SimplexNoise::noise(f32 xin, f32 yin, f32 zin) 
{
